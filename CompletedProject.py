...
if selected == "Basic Overview":
    ...
    st.markdown("<h1 style='text-align: center; font-size: 40px; color: #ff0bab;'> <u> Created By Ashwin Rajh </u> </h1", unsafe_allow_html=True)
...
if selected == "Data Prediction":
    ...
    with tab1:    
            ...
            if submit_button and flag==0:
                ...
                with open(r"item_type.pkl", 'rb') as f:
